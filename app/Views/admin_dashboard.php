...
<div class="container mt-5">
    ...
    <!-- TABLEAU TRAJETS (identique page trajets, full width) -->
    <div class="card mb-4 ">
    ...
    <!-- DEUX COLONNES : Users et Agences -->
    <div class="row g-4">
        <!-- Utilisateurs -->
        <div class="col-md-6">
            <div class="card">
                            ...
                            <tbody>
                                ...
                                <?php else: foreach ($agences as $agence): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/TOUCHE_PAS_AU_KLAXON/public/admin/agence/edit/<?= $agence['id_agence'] ?>" class="text-primary me-2" title="Modifier"><i class="bi bi-pencil"></i></a>
